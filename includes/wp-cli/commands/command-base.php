 ...
 * @package WPCV_CGI
 */
abstract class WPCV_CGI_CLI_Command_Base extends \WP_CLI\CommandWithDBObject {
	...
	public static function check_dependencies() {
		...
		// Check for existence of the "Groups" plugin.
		if ( ! defined( 'GROUPS_CORE_VERSION' ) ) {
			WP_CLI::error( 'Unable to find Groups install.' );
		}
	...
	protected function site_timezone_get() {
		...
		$tzstring = wp_cache_get( 'cvgrp_timezone' );
		...
		if ( false === $tzstring ) {
			...
			wp_cache_set( 'cvgrp_timezone', $tzstring );
