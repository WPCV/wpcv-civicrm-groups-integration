 ...
 * Settings Page abstract class.
 *
 * This is a modified copy of the CiviCRM Admin Utilities class.
 *
 * @since 0.3.0
 */
abstract class WPCV_CGI_Page_Settings_Base {
	...
	protected function admin_help_get() {
		...
		if ( ! file_exists( $template ) ) {
			$template = WPCV_CGI_PATH . $this->path_template . $this->path_help . 'page-settings-help.php';
		}
	...
	public function page_render() {
		...
		if ( ! file_exists( $template ) ) {
			$template = WPCV_CGI_PATH . $this->path_template . $this->path_page . $template_name;
		}
	...
	public function meta_box_submit_render( $unused, $metabox ) {
		...
		if ( ! file_exists( $template ) ) {
			$template = WPCV_CGI_PATH . $this->path_template . $this->path_metabox . 'metabox-settings-submit.php';
		}
