...
class WPCV_CGI_Admin_Batch {
	...
	public function __construct( $identifier ) {
		...
		$this->stepper = new WPCV_CGI_Admin_Stepper( $identifier );
	...
	public function delete() {
		...
		if ( ! isset( $this->stepper ) ) {
			$this->stepper = new WPCV_CGI_Admin_Stepper( $this->identifier );
		}
		$this->stepper->delete();
		unset( $this->stepper );
